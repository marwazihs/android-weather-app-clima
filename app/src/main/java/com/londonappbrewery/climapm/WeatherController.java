...
public class WeatherController extends AppCompatActivity {
    ...
    final int REQUEST_CODE = 1980;
    final String WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather";

    // App ID to use OpenWeather data
    // Key generated by marwazihs@gmail.com
    final String APP_ID = "1959ecb2cc8f66f11a2d7c17569db58d";
    ...
    protected void onResume() {
        ...
        if (city != null) {
            ...
            Log.d("Clima", "Getting weather from the current location...");
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                //Prepare the parameter -- this is using jLoop Library
                RequestParams params = new RequestParams();
                params.put("lat",latitude);
                params.put("lon", longitude);
                params.put("appid",APP_ID);

                //initiate and get the data from Open Weather
                letsDoSomeNetworking(params);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                //user has granted permission hence get the updatelocation
                Log.d("Clima", "onRequestPermissionResult(): Permission Granted!");
                getWeatherForCurrentLocation();
            } else {
                Log.d("Clima", "Permission Denied by the user!! Fuck!");
            }
        }
...
// TODO: Add letsDoSomeNetworking(RequestParams params) here:
    ...
    // this is to destroy the mLocationManager to preserve battery
    @Override
    protected void onPause() {
        super.onPause();

        if (mLocationManager != null) {
            Log.d("Clima","removing location update..");
